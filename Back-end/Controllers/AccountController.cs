...
using Back_end.Providers;
using Back_end.Results;
...
namespace Back_end.Controllers
{
  ...
  /*      [HostAuthentication(DefaultAuthenticationTypes.ExternalBearer)]
        ...
        // GET api/Account/UserInfo?id={id}
        [ResponseType(typeof(AppUserInfoViewModel))]
        [Route("UserInfo")]
        public IHttpActionResult GetUserInfo(string UserID)
        {
            ...
            return Ok(new AppUserInfoViewModel
            {
                UserID = user.Id,
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUser() { UserName = model.Email, Email = model.Email, UserNick = model.UserNick };
